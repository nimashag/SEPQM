...
router.post('/', authenticate, authorizeRoles("restaurantAdmin"), ctrl.create);
...
router.put('/:id', authenticate, authorizeRoles("restaurantAdmin"), ctrl.update);
router.delete('/:id', authenticate, authorizeRoles("restaurantAdmin"), ctrl.remove);


router.post('/:id/menu-items', authenticate, authorizeRoles("restaurantAdmin"), ctrl.addMenuItem);
...
router.put('/:id/menu-items/:itemId', authenticate, authorizeRoles("restaurantAdmin"), ctrl.updateMenuItem);
